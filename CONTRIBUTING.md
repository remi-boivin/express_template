...
2. Install or update to **Node.js v16**. For more information, see [the code installation documentation](server/README.md).
...
Congratulations :tada::tada: The Ogre team thanks you :sparkles:.

Once your PR is merged, your contributions will be publicly visible.

Now that you are part of the spelkolektivet community.
